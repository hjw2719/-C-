...
int main() {
    ...
    int nCChineseSize = sizeof(CChinese);
    int nCEnglishSize = sizeof(CEnglish);

    
    std::cout << nPersonSize << std::endl;
    std::cout << nCChineseSize << std::endl;
    std::cout << nCEnglishSize << std::endl;
